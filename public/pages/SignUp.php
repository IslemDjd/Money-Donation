            ...
            <section class="relative flex h-32 items-end bg-gray-900 lg:col-span-5 lg:h-full xl:col-span-6">
                ...
                <div class="hidden lg:relative lg:block lg:p-12">
                    ...
                    <p class="mt-4 leading-relaxed text-white">
                        We Are dedicated to improving lives through a variety of projects aimed at addressing key issues
                        in our communities. We believe in the power of collective action and provide a platform for
                        donors to contribute to meaningful causes
                    </p>
                </div>
            </section>
